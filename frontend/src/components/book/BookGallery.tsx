...
const BookGallery: FC<BookGalleryProps> = ({ coverImage, title }) => {
  return (
    <div className="lg:col-span-5 flex justify-center sticky top-24">
      ...
      <div className="w-[70%] sm:w-[80%] md:w-full max-w-[280px] md:max-w-[400px] relative aspect-[2/3] rounded-xl overflow-hidden shadow-2xl bg-inverse-surface dark:bg-surface-container-high border border-outline-variant/30 flex justify-center items-center group">
